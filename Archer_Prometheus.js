...
function drawScreen() {
    ...
    for (var i = 0; i < char.length; i++) {
        if ((char[i].x + 50 > boss.x - 96) && (char[i].x < boss.x + 214) &&
            (char[i].y < boss.y + 214) && (char[i].y > boss.y - 96)) {
            targetChar = i;
            char_flag = true;
            break;
    ...
    for (i = 0; i < PBulletArr.length; i++) {
        if (PBulletArr[i].goX == 0 && PBulletArr[i].goY == 0) {
            switch (PBulletArr[i].way) {
                case 1:
                    Context.drawImage(swing_image, char[1].x - PBulletArr[i].x,
                        char[1].y + PBulletArr[i].y);
                    var a = i;
                    setTimeout(function() {
                        PBulletArr.splice(a, 1)
                    }, 200);
                ...
                case 2:
                    Context.save();
                    Context.rotate(90 * Math.PI / 180);
                    Context.drawImage(swing_image, char[1].y + PBulletArr[1].y - 85, (-1) * (char[1].x + PBulletArr[i].x - 5));
                    Context.restore();
                    var a = i;
                    setTimeout(function() {
                        PBulletArr.splice(a, 1)
                ...
                case 3:
                    Context.save();
                    Context.rotate(180 * Math.PI / 180);
                    Context.drawImage(swing_image, (-1) * (char[1].x + PBulletArr[i].x), (-1) * (char[1].y + PBulletArr[i].y));
                    Context.restore();
                    var a = i;
                    setTimeout(function() {
                        PBulletArr.splice(a, 1)
                ...
                case 4:
                    Context.save();
                    Context.rotate(-90 * Math.PI / 180);
                    Context.drawImage(swing_image, (-1) * (char[1].y + PBulletArr[i].y + 95),
                        char[1].x + PBulletArr[i].x - 41);
                    Context.restore();
                    var a = i;
                    setTimeout(function() {
                        PBulletArr.splice(a, 1)
